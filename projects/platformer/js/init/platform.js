(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(420, 550); //3
        platform.create(450, 240); //1
        platform.create(168, 550); //4
        platform.create(25,  340, .3); //2
        platform.create(450, 430); //5
        platform.create(100, 340, .3)//6
